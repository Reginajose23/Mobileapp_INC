...
@Component({
  selector: 'app-dailyverse',
  templateUrl: './dailyverse.page.html',
  styleUrls: ['./dailyverse.page.scss'],
})
export class DailyversePage implements OnInit {

  url = 'https://indianchurches.org/get_status.php?id=2';

  url1= 'https://indianchurches.org/get_gurl.php';
